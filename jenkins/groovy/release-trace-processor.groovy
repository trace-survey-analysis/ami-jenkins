multibranchPipelineJob('trace-processor-build-and-publish') {
    ...
    branchSources {
        branchSource {
            source {
                github {
                    id('trace-processor-build-and-publish')
                    credentialsId('github-pat')
                    configuredByUrl(true)
                    repoOwner('cyse7125-sp25-team03')
                    repository('trace-processor')
                    repositoryUrl('https://github.com/cyse7125-sp25-team03/trace-processor.git')
                }
            }
        }
    }
