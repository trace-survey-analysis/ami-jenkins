multibranchPipelineJob('commitlint-check-webapp-hello-world') {
    ...
    branchSources {
        branchSource {
            source {
                github {
                    id('commitlint-check-webapp-hello-world')
                    credentialsId('github-pat')
                    configuredByUrl(true)
                    repoOwner('cyse7125-sp25-team03')
                    repository('webapp-hello-world')
                    repositoryUrl('https://github.com/cyse7125-sp25-team03/webapp-hello-world.git')
                }
            }
        }
    }
